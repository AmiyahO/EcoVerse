...
const CATEGORIES = [
  { icon: '🚶', color: '#66BB6A', name: 'Walking',     desc: 'Log steps or distance. Every km on foot = ~0.21 kg CO₂ avoided vs driving.' },
  { icon: '🚴', color: '#26C6DA', name: 'Cycling',     desc: 'Even short rides add up. Cycling is one of the highest-impact habit changes.' },
  { icon: '🏃', color: '#FFA726', name: 'Running',     desc: 'Track runs by distance and duration. Combines movement and CO₂ savings.' },
  { icon: '⚡', color: '#FFEE58', name: 'Electricity', desc: 'Enter your monthly meter reading. We calculate savings vs your previous bill.' },
  { icon: '💧', color: '#29B6F6', name: 'Water',       desc: 'Log monthly usage in litres. Even small reductions in water use matter.' },
];
...
const styles = StyleSheet.create({
  ...
  catIcon: { width: 42, height: 42, borderRadius: 12, alignItems: 'center', justifyContent: 'center', borderWidth: 1, flexShrink: 0 },
