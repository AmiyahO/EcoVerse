...
export const CHALLENGES: Challenge[] = [
  ...
  // ── CO₂ challenges (one guaranteed per weekly rotation via challengeGroup) ──
  {
    id:            'carbon-starter',
    title:         'Carbon Starter',
    description:   'Save 0.5 kg of CO₂ through eco-friendly activities this week.',
    icon:          'seedling',
    color:         '#66BB6A',
    difficulty:    'easy',
    challengeType: 'weekly',
    goal:          { metric: 'co2', target: 0.5, categories: ['walking', 'running', 'cycling', 'electricity', 'water'] },
    rewardTokens:  90,
    badgeLabel:    'Carbon Seedling',
  },
  {
    id:            'green-impact',
    title:         'Green Impact',
    description:   'Save 1 kg of CO₂ across all your activities this week.',
    icon:          'leaf',
    color:         '#43A047',
    difficulty:    'medium',
    challengeType: 'weekly',
    goal:          { metric: 'co2', target: 1, categories: ['walking', 'running', 'cycling', 'electricity', 'water'] },
    rewardTokens:  130,
    badgeLabel:    'Green Influencer',
  },
  {
    id:            'climate-contender',
    title:         'Climate Contender',
    description:   'Save 2 kg of CO₂ this week through any combination of activities.',
    icon:          'globe',
    color:         '#2E7D32',
    difficulty:    'hard',
    challengeType: 'weekly',
    goal:          { metric: 'co2', target: 2, categories: ['walking', 'running', 'cycling', 'electricity', 'water'] },
    rewardTokens:  180,
    badgeLabel:    'Climate Contender',
  },
  {
    id:            'carbon-crusher',
    title:         'Carbon Crusher',
    description:   'Save 5 kg of CO₂ this week. Every action counts.',
    icon:          'earth-americas',
    color:         '#1B5E20',
    difficulty:    'epic',
    challengeType: 'weekly',
    goal:          { metric: 'co2', target: 5, categories: ['walking', 'running', 'cycling', 'electricity', 'water'] },
    rewardTokens:  400,
    badgeLabel:    'Carbon Crusher',
  },
];
