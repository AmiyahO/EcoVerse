// This utility can be used to recalculate tokens and carbon saved for all activities, e.g. after fixing a bug in the calculation logic. 
// It iterates through all logged activities, recalculates their tokens and carbon savings, and updates the user's total in Firestore.
