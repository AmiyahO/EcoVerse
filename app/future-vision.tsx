...
// Static "What's Next" screen — shows planned directions to evaluators and testers.
// All content is clearly labelled as planned, not currently live.
...
function VisionCardView({ card, colors }: { card: VisionCard; colors: any }) {
  return (
    <View style={[styles.card, { backgroundColor: colors.surface, borderColor: card.iconColor + '28' }]}>
      ...
      <View style={[styles.tagBadge, { backgroundColor: card.iconColor + '15', borderColor: card.iconColor + '30' }]}>
        <FontAwesome6 name="clock" size={10} color={card.iconColor} />
        <ThemedText style={[styles.tagText, { color: card.iconColor }]}>{card.tag}</ThemedText>
      </View>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
        ...
        >
          ...
          <View style={[styles.heroBadge, {
            backgroundColor: colors.tint + '18', borderColor: colors.tint + '30',
          }]}>
        ...
        <View style={[styles.footer, {
          backgroundColor: colors.surfaceMuted + '60',
...
const styles = StyleSheet.create({
  ...
  cardSub:    { fontSize: 12, opacity: 0.5, marginTop: 2 },
