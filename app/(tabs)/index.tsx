...
import { calculateTokens, calculateCarbonSaved, getEcoZone, getWeekCarbonComparison, CATEGORY_COLORS } from '@/src/utils/ecoLogic';
...
export default function HomeScreen() {
  ...
  const comparisonColor =
    ...
    comparison.direction === 'down' ? '#EF5350' :
    colors.text;
        ...
        >
          ...
          <View style={styles.scoreWrapper}>
            ...
            <View style={styles.heroRight}>
              <ThemedText style={[styles.zoneMessage, { color: colors.text }]}>
                {zone.message}
              </ThemedText>
        ...
        <View style={[styles.card, { backgroundColor: colors.surface }]}>
          ...
          {recentActivity ? (
            ...
            >
              <View style={[
                styles.recentIcon,
                { backgroundColor: (CATEGORY_COLORS[recentActivity.category] ?? colors.tint) + '22' }
              ]}>
                <FontAwesome6
